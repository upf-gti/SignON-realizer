...
class HandShapeRealizer {
    ...
    _createGestureFromCurrentPose( indexes ){
        ...
        o.little = [ b[ indexes.little ].quaternion.clone(), b[ indexes.little + 1 ].quaternion.clone(), b[ indexes.little + 2 ].quaternion.clone() ];
        return o;
    }
    ...
    init( character ){
        ...
        this.right.idxs = { wrist: 0, thumb: 0, index: 0, middle: 0, ring: 0, little: 0 };
        this.left.idxs = { wrist: 0, thumb: 0, index: 0, middle: 0, ring: 0, little: 0 };
        ...
        for( let i = 0; i < bones.length; ++i ){
            ...
            else if ( bones[i].name.includes("RightHandPinky1") ){ this.right.idxs.little = i; }
            ...
            else if ( bones[i].name.includes("LeftHandPinky1") ){ this.left.idxs.little = i; }
    ...
    _updateHand( dt, hand ) {
        ...
        for( let i = 0; i < 3; ++i ){
            ...
            bones[ hand.idxs.little + i ].quaternion.slerpQuaternions( hand.g[0].little[i], hand.g[1].little[i], t );
        }
    ...
    newGestureBML( bml ){
        ...
        this.newGesture( bml.handshape, duration, bml.thumb, bml.hand );
    }
